...
class IndexConfig
{
    ...
    /**
     * Indicates how many last indexes should be saved, allowing fast switch if index was corrupted
     *
     * @var int
     */
    private $saveLastIndex = 0;
    ...
    public function __construct($name, array $types, array $config)
    {
        ...
        $this->saveLastIndex = isset($config['saveLastIndex']) ? $config['saveLastIndex'] : 0;
    }
     ...
     * @return int
     */
    public function getSaveLastIndex()
    {
        return $this->saveLastIndex;
    }
}
